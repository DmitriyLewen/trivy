...
// TODO: remove after https://github.com/aquasecurity/trivy-db/pull/657 is merged
replace github.com/aquasecurity/trivy-db => github.com/chait-slim/trivy-db v0.0.0-20260507091439-02ab036fd7cd
